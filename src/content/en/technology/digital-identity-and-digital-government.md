...
The final straw came from Legislative Yuan questioning. In December 2020, multiple legislators repeatedly grilled Interior Minister Xu Guoyong in committee sessions, demanding the suspension of card issuance. On January 12, 2021, the Executive Yuan announced the suspension of digital ID card issuance "in response to social concerns."

Five years of preparation wiped out with one sentence.

### The Compensation Storm

After the suspension announcement, participating contractors began seeking compensation. System development and software construction alone resulted in NT$526 million in government claims. Adding purchased card readers, printing equipment, facility rental, and air conditioning costs, the total reached approximately NT$1.05 billion.

This bill ultimately fell to taxpayers. The Ministry of the Interior quietly budgeted related compensation expenses in its 2024 budget documents.

## A 2022 Fresh Start: Birth of the Ministry of Digital Affairs

### Digital Governance Integration

On August 27, 2022, the Ministry of Digital Affairs (MODA) officially opened. This new ministry integrated digital operations previously scattered across various departments:

Information services from the National Development Council, IT industry policy from the Ministry of Economic Affairs, telecommunications regulation from the Ministry of Transportation, and cybersecurity coordination from the Executive Yuan — all consolidated under MODA. Former Political Minister Audrey Tang became the first minister.

MODA's core mission was clear: rebuild public trust in government digital services.
...
Most unique is the "Democracy Network Division" — probably the only government department worldwide specifically dedicated to "digital democracy." This design directly addresses the core of the New eID controversy: government digitalization can't only focus on efficiency; it must emphasize democratic participation.

## MyEGov: A Decade of Integration Platform Refinement

### From Information Silos to One-Stop Services
...
These innovations bypass New eID controversies through gradual improvement rather than revolutionary replacement, making digital services more accessible.

## Natural Person Certificate: A 21st Century Living Fossil
...
The fundamental reason for poor Natural Person Certificate adoption isn't technical but user experience:

1. **Cost required**: NT$250 fee makes people think "I don't often use government services, why pay?"
2. **Physical visit needed**: Must apply in person at household registration offices, no proxy allowed
...
But Natural Person Certificates experienced a second spring during the pandemic. When COVID-19 escalated in 2021, the government launched digital vaccination certificates, making Natural Person Certificates the most convenient download method. Combined with mask rationing systems and quintuple stimulus vouchers available through certificate applications, usage rates increased significantly.

## Digital Divide: No One Should Be Left Behind
...
**Elderly population**: Over 3.8 million people aged 65+ nationwide, with less than 30% using smartphones. When pandemic mask rationing went online, many elderly had to rely on children for help.

**New immigrants**: Language is the biggest barrier. Though government websites have multilingual versions, interfaces remain primarily Chinese-focused, challenging for non-native Chinese speakers.
...
4. **Consensus formation**: Synthesizing various opinions to find viable solutions
5. **Policy recommendations**: Delivering consensus to government for reference

The most successful case was online alcohol sales regulations. Discussions began in 2016, legislation passed in 2017, and operations continue successfully today.

### Audrey Tang's "Rough Consensus"
...
### Zero Trust Architecture's New Thinking

Starting 2023, the government began implementing "Zero Trust" cybersecurity architecture. Core concept: "Never trust, always verify."

Traditional cybersecurity treated internal government networks as "secure zones" — once hackers entered, they moved freely. Zero Trust architecture assumes internal networks are also insecure, requiring re-verification for every data access.

This architecture has been piloted in finance-related agencies like the Ministry of Finance and Financial Supervisory Commission with good results.

## Open Data: Digital Foundation of Government Transparency
...
### Data Wars During the Pandemic

During the pandemic, open data played crucial roles. Mask rationing system success largely came from government real-time release of mask inventory data, enabling civilian developers to create "mask maps."
...
3. **Open and transparent**: Policy-making processes are public, data is as open as possible

This model may not be fastest, but it's most stable.

## Future Challenges: Digital Government in the AI Era
...
These questions lack standard answers, requiring practical exploration.

### Will Digital ID Cards Resurrect?
...
Long-term, some form of digital ID cards will likely emerge. The key lies in rebuilding trust, ensuring privacy, and making citizens truly feel the convenience.
...
- [MyEGov Portal](https://www.gov.tw/)
- [Ministry of Interior Household Registration Digital ID Section](https://www.ris.gov.tw/app/portal/789)
