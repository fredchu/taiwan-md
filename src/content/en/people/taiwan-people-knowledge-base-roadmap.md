---
title: 'Taiwan People Knowledge Base Project — 200 People Initiative'
description: 'Taiwan.md people page expansion roadmap, aiming to cover 200 important figures representing Taiwan'
date: 2026-03-19
tags: [project, People, roadmap]
---

# Taiwan People Knowledge Base Project — 200 People Initiative

> Current: 39 people → Target: 200 people
> Each figure gets an independent .md file, 800-1500 words, with reference URLs

---

## Existing Figures (39 people) ✅

Ang Lee, Morris Chang, Tsai Ing-wen, Tai Tzu-ying, Hou Hsiao-hsien, Jay Chou, Audrey Tang, Teresa Teng, Lee Yuan-tseh, Wu Ming-yi, Lai Ching-te, Wu Che-yu, Kuo Hsing-chun, Yang-Lee Pair, Yang Yung-wei, Lee Chih-kai, Chi Po-lin, Aaron Nieh, Crowd Lu, André Chiang, Jensen Huang, Lin Hwai-min, Stan Shih, Lee Teng-hui, Wu Ta-you, Chen Wei-yin, Wang Chien-ming, Jolin Tsai, Mayday, Wei Te-sheng, Chen Shu-chu, Jimmy Liao, Terry Gou, Stanley Yen, Annette Lu, Kao Chun-ming, Jeremy Lin, Ju Tzong-ching, Kevin Lin

---

## Phase 1: Expand to 100 People (+61 people) 🔴 Priority
...
## Phase 2: Expand to 200 People (+100 people) 🟡 Mid-term

### 🎬 Film & TV Extension (+10)

Chung Mong-hong, Zhao Deyin, Lin Zheng-sheng, Zhang Zuoji, Wang Xiaodi, Ke Yizheng, Wu Nianzhen, Giddens Ko, Yi Zhiyan, Zheng Youjie

### 📚 Literature Extension (+10)

Yang Mu, Yu Guangzhong, Zheng Chouyu, Zhang Dachun, Luo Yijun, Wu Sheng, Ping Lu, Liao Yuhuan, Jian Zhen, Syaman Rapongan

### 🎵 Music Extension (+10)

Cheer Chen, Chang Chen-yue, Huang Ke, Fire EX., Chthonic, EggPlantEgg, Tell Five, Sunset Rollercoaster, No Party For Cao Dong, Amazing Show

### ⚽ Sports Extension (+10)

Pan Zhengcong (golf Olympic bronze), Tang Zhijun (archery), Wen Ziyun (karate), Huang Xiaowen (boxing), Fang Wanling (surfing), Lin Yunru (table tennis), Lei Qianying (archery), Chen Nianqin (boxing), Huang Yiting (cycling), Hong Yuanxi (wrestling)

### 💻 Tech Business Extension (+10)

Zhao Tengxiong (Farglory), Gu Zhenfu (Gu family), Cai Wancai (Fubon), Guo Taiqiang (Foxlink), Lin Weishan (Tatung), Cai Yanming (Want Want), Yin Yanliang (Ruentex), Dai Shengyi (Wang Group), Wu Dongliang (Taishin), Chen Taiming (Yageo)

### 🔬 Academic Extension (+10)

Shing-Tung Yau (mathematics), Zhang Zhonggang (materials), Liao Junzhi (current Academia Sinica president), Kuan Chung-ming (NTU president controversy), Peng Minghui (public intellectual), Huang Kunyan (medical humanities), David Ho (AIDS cocktail therapy), Du Congming (Taiwan's first medical PhD), Cai Yuanpei (Taiwan academic connections), Lian Riqing (entomologist)

### 🏛️ Politics & Society Extension (+10)

Ko Wen-je, Han Kuo-yu, Huang Kuo-chang, Lin Changzuo, Xiao Meiqin, Chen Ju, Xie Changting, You Xikun, Su Zhenchang, Wu Dunyi
...
Wu Bao-chun (world bread champion), A-ji Chef (national chef), Lin Linxu (braised pork rice culture), Ye Yilan (food culture writer), Shi Jianfa (Master A-fa, state banquet chef)

### 🎭 Performing Arts (+5)

Xu Xiaoxu (variety), Chang Hsiao-yen (variety godmother), Wu Zongxian (variety king), Liao Qiongzhi (Taiwanese opera national treasure), Li Tianlu (puppetry master)
...
Yo-Yo Ma (Taiwanese-American cellist), Leehom Wang (Taiwan-American mixed singer), Lee Kotomi (Taiwan writer in Japan, Akutagawa Prize), Jason Wu (fashion designer), Steve Chen (YouTube co-founder)

---

## Selection Principles

1. **International Visibility**: International-level achievement or fame in their field
2. **Historical Position**: Pioneering or milestone contributions to Taiwan in some field
3. **Diverse Representation**: Balanced gender, ethnicity, generation, and field distribution
4. **Include Controversial Figures**: Political figures from across the spectrum, presenting complete range
5. **Indigenous Representatives**: A-mei, Syaman Rapongan and other indigenous figures prioritized
...
- Factual accuracy (years, awards, achievements need cross-verification)
- Use `[[Name]]` wikilinks to connect other existing figures

---

_Project Team: Taiwan.md Team | March 19, 2026_